...
int32_t* get_usharp_use_system_env_var_switch_ptr()
{
    if (!g_usharp_use_system_env_var_switch_ptr.has_value())
    {
        ...
        auto usharp_enable_hookenv = "55 00 53 00 68 00 61 00 72 00 70 00 20 00 45 00 6E 00 61 00 62 00 6C 00 65 00 20 00 48 00 6F 00 6F 00 6B 00 45 00 6E 00 76 00 56 00 61 00 72 00 00 00";
        uint64_t usharp_enable_hookenv_ptr = signature(usharp_enable_hookenv);
